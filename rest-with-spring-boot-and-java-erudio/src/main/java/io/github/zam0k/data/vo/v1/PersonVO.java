...
public class PersonVO extends RepresentationModel<PersonVO> implements Serializable {
	...
	public boolean equals(Object o) {
		...
		return getKey().equals(personVO.getKey())
				...
				&& getAddress().equals(personVO.getAddress())
				&& getGender().equals(personVO.getGender())
				&& getEnabled().equals(personVO.getEnabled());
	}

	@Override
	public int hashCode() {
		return Objects.hash(super.hashCode(), getKey(), getFirstName(),
				getLastName(), getAddress(), getGender(), getEnabled());
	}
}